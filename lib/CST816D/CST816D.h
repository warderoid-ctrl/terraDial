...
// Copied from the Elecrow CrowPanel 1.28" factory example
// (example/RotaryScreen_1_28_new/CST816D.h) -- this is the vendor's driver
// for the exact touch controller on this board, reused as-is rather than
// re-derived.
